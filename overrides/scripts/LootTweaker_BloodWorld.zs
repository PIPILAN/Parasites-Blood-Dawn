...
// 创建新表（弃用）
// 格式为 val 临时变量A = LootTweaker.newTable("loottweaker:表名");
// val BloodCityTable = LootTweaker.newTable("loottweaker:bloodcity");
// val BloodCityRailTable = LootTweaker.newTable("loottweaker:bloodcityrail");
...
// val BloodCityRailPool = BloodCityRailTable.addPool("bloodrailpool", 3, 12, 0, 1);
